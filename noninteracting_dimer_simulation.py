...
def calc_n_labeled_dimer(n_peptides, pfluorophore, pnonspecific):
    """
...
def simulate_occupancy_dimer(n_peptides, n_smalps, distribution, n_bins,
...
def main():
    ...
    matrix_list = simulate_occupancy_dimer(n_peptides, n_smalps,
                                           smalp_core_radius_distribution,
                                           n_bins, pfluorophore, pnonspecific)
