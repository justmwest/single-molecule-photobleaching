...
from calc_n_smalps import gen_radius_bins
...
def simulate_occupancy(n_peptides, n_smalps, distribution, n_bins, pfluorophore, pnonspecific):
    """
    ...
    """
    matrix_list = []
    bin_edges = gen_radius_bins(distribution, n_bins)
...
def calc_p_star(matrix_list, n_smalps):
    ...
    try:
        ...
        raise IndexError("Check simulation results. Can't find p1, p2, p3.")
...
def main():
    ...
    n_std_devs = 5
    largest_radius_to_consider = smalp_core_radius_mean + smalp_core_radius_std_dev * n_std_devs
    smallest_radius_to_consider = smalp_core_radius_mean - smalp_core_radius_std_dev * n_std_devs
    ...
    # Run the simulation
    matrix_list = simulate_occupancy(n_peptides, n_smalps,
                                     smalp_core_radius_distribution, n_bins,
